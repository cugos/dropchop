...
[Project installation](https://github.com/cugos/dropchop/wiki/Installing-the-Project) can be found in the wiki. Dropchop is now officially in `0.1`, which means progress is stable and contributions are welcomed with open arms. For starters, take a look at how we are using ["triggers"](https://github.com/cugos/dropchop/wiki/Triggers) to execute commands across the code base.
...
<img src="assets/drop-n-chop-logo.png" width="100%">